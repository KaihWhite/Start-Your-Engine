...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("C:/Visual Studio/OpenGL/OpenGL/src/shader/3.3.smiley.vs", "C:/Visual Studio/OpenGL/OpenGL/src/shader/3.3.smiley.fs");
    ...
    unsigned char* data = stbi_load("C:/Visual Studio/OpenGL/OpenGL/src/testures/container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
